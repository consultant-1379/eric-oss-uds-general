 ...
 * ================================================================================
 */
package commonapplogging.src.main.java.org.openecomp.sdc.common.log.enums;
...
public enum EcompLoggerErrorCode {
    ...
    private static boolean isCode(EcompLoggerErrorCode ecompLoggerErrorCode, String errorPrefix) {
        ...
        //return String.valueOf(ecompLoggerErrorCode.getEcompLoggerErrorCode()).contains(errorPrefix);
    }
