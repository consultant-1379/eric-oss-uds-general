...
public class LoggerSecurity extends LoggerBase {


    private static ArrayList<String> mandatoryFields = new ArrayList<>(Arrays.asList(ONAPLogConstants.MDCs.REQUEST_ID));


    LoggerSecurity(ILogFieldsHandler ecompMdcWrapper, Logger logger) {
        super(ecompMdcWrapper, MarkerFactory.getMarker(LogMarkers.SECURITY_MARKER.getText()), logger);
    }

    @Override
    public LoggerSecurity clear() {
        //nothing to clean up
        return this;
    }
    ...
    public void log(LogLevel logLevel, String message, Object... params) {
        ...
        super.log(logLevel.SECURITY, message, params);
    }
    ...
    @Override
    public LoggerSecurity startTimer() {
        return this;
    }
