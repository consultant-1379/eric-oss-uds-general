...
public class YamlToObjectConverter {
    ...
    static {
        ...
        Constructor deConstructor = new Constructor(DistributionEngineConfiguration.class, loaderOptions);
        ...
        // FE conf
        Constructor feConfConstructor = new Constructor(org.openecomp.sdc.fe.config.Configuration.class, loaderOptions);
        ...
        // BE conf
        Constructor beConfConstructor = new Constructor(org.openecomp.sdc.be.config.Configuration.class, loaderOptions);
        ...
        Constructor depArtHeatConstructor = new Constructor(DeploymentArtifactHeatConfiguration.class, loaderOptions);
    ...
    private static <T> Yaml getYamlByClassName(Class<T> className) {
        ...
        LoaderOptions loaderOptions = new LoaderOptions();
        loaderOptions.setTagInspector(tag -> true);
        return yamlConstructor == null ? new Yaml(loaderOptions) : new Yaml(yamlConstructor);
    }
    ...
    public boolean isValidYaml(byte[] fileContents) {
        try {
            LoaderOptions loaderOptions = new LoaderOptions();
            loaderOptions.setTagInspector(tag -> true);
            Iterable<Object> mappedToscaTemplateIt = new Yaml(loaderOptions).loadAll(new ByteArrayInputStream(fileContents));
